...
public class AddConvFactory extends ConversationFactory {

    public AddConvFactory() {
        ...
        this.abandonedListeners.add(new ConversationAbandonedListener() {
            ...
            public void conversationAbandoned(ConversationAbandonedEvent abandonedEvent) {
                ...
                if (canceller != null) {
                    player.sendMessage(LangUtils.getString("add-convo-cancelled"));
                }
    ...
    private static class AddConversation extends StringPrompt {
        ...
        public String getPromptText(ConversationContext context) {
            return LangUtils.getString("add-convo-prompt");
        }
